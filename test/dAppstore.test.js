...
contract('dAppStore', (accounts) => {
    ...
    // it('Create - Should create a new app', async () => {
    //     const idx = `0`;
    //     const name = "name" + idx;
    //     const description = "description" + idx;
    //     const link = "link" + idx;
    ...
    //     const category = "category" + idx;
    //     const fileSha = "fileSha" + idx;
    //     const app = await dAppStore.createNewApp(name,
    //                                              description,
    //                                              link,
    //                                              img,
    //                                              company,
    ...
    //                                             );
    //     assert.isOk(app);
    //     expectAppInfo(app, idx);
    //     //catch app created event
    //     // truffleAssert.eventEmitted(result, 'TestEvAppCreatedent', (ev) => {
    ...
    //     //create app
    //     const idx = dAppStore.getAppCount().then(res => res.toNumber());
    //     const tx = await dAppStore.createNewApp(
    //         "name" + idx,
    //         "description" + idx,
    //         "link" + idx,
    //         "img" + idx,
    ...
    //     const allEvents = await dAppStore.getPastEvents('allEvents',{ fromBlock:0, toBlock:'latest'});
    ...
    //     const appCount = await dAppStore.getAppCount().then(res => res.toNumber());
    //     const rnd_idx = Math.floor(Math.random() * appCount);
    //     const receipt = await dAppStore.purchaseApp(rnd_idx, { from: new_user, value: 8 });
